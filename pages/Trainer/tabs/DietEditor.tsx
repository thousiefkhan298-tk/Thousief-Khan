        ...
        <div className="space-y-2 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
          {clients.map(c => (
            ...
            >
              ...
              <div className={`text-[10px] uppercase font-black ${activeClient === c.id ? 'text-black/60' : 'text-neutral-600'}`}>Edit Nutrition</div>
            </button>
          ))}
        </div>
      </div>
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-8 space-y-6">
            ...
            ></textarea>
             ...
             <div className="p-4 bg-lime-500/5 border border-lime-500/20 rounded-2xl flex items-start gap-4">
               <i className="fas fa-apple-whole text-lime-500 mt-1"></i>
               <div>
                  <p className="text-xs font-bold text-white uppercase">Nutrition Tip</p>
                  <p className="text-[11px] text-neutral-400 leading-relaxed mt-1">Include macro counts and hydration goals to help the client stay on track.</p>
               </div>
            </div>
          </div>
        ) : (
